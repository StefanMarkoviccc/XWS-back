...
namespace MessageService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MessageContext>(optionsBuilder => { });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MessageContext messageContext)
        {
